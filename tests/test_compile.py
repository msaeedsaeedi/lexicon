...
from lexicon.version import DATASET_VERSION, PIPELINE_VERSION
...
def test_cli_build_generates_equivalent_artifacts(tmp_path: Path) -> None:
    ...
    jsonl_path = tmp_path / f"lexicon-en-core-{DATASET_VERSION}.jsonl"
    sqlite_path = tmp_path / f"lexicon-en-core-{DATASET_VERSION}.sqlite"
