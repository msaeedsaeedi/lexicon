    ...
    record = StagedLexeme.model_validate(
        {
            ...
            "part_of_speech": "noun",
            "senses": [
                {"definitions": [{"text": "A test."}], "examples": [{"text": "This is a test."}]}
            ],
        }
    )
...
def test_conflicting_normalized_duplicates_are_rejected() -> None:
    ...
    first = StagedLexeme.model_validate(
        {
            "source_id": "seed",
            "language": "en",
            "lemma": "test",
            "part_of_speech": "noun",
            "senses": [{"definitions": [{"text": "First."}], "examples": [{"text": "A test."}]}],
        }
    )
    second = StagedLexeme.model_validate(
        {
            "source_id": "seed",
            "language": "en",
            "lemma": " Test ",
            "part_of_speech": "noun",
            "senses": [{"definitions": [{"text": "Second."}], "examples": [{"text": "A test."}]}],
        }
    )
